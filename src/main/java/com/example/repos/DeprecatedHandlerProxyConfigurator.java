...
public class DeprecatedHandlerProxyConfigurator implements ProxyConfigurator {
    ...
    public Object replaceWithProxyIfNeeded(Object t, Class implClass) {
        if (implClass.isAnnotationPresent(Deprecated.class)) {
            ...
            if (implClass.getInterfaces().length == 0) {
                return Enhancer.create(implClass, (net.sf.cglib.proxy.InvocationHandler) (o, method, args) -> getInvocationHandlerLogic(method, args, t));
            }
    ...
    private Object getInvocationHandlerLogic(Method method, Object[] args, Object t) throws IllegalAccessException, InvocationTargetException {
        System.out.println("************ What are you doing?! It's deprecated Class! *************");
